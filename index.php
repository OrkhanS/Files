...
<body>
		...
		<br><br><form>
         <input type = "button" value = "Pay" onclick = "getConfirmation();" />
      </form>
<br><br><hr><br>		
		...
		<script>
            ...
            function getConfirmation() {
               var retVal = confirm("Do you want to save card info for future payment ?");
               if( retVal == true ) {
                  	window.location.href = "http://localhost/index_yes.php";
                  return true;
               } 
               else
               {
               		window.location.href = "http://localhost/index_no.php";
               }
            }
